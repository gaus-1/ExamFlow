...
urlpatterns = [
    ...
    # Callback'и OAuth
    path('telegram/callback/', views.telegram_callback, name='telegram_callback'), # type: ignore
    path('google/callback/', views.google_callback, name='google_callback'), # type: ignore
    path('yandex/callback/', views.yandex_callback, name='yandex_callback'), # type: ignore
