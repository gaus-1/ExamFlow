...
try:
    from telegram_bot.bot_handlers import (
        ai_help_handler as _ai_help_handler,
        ai_explain_handler as _ai_explain_handler,
        ai_personal_handler as _ai_personal_handler,
        ai_hint_general_handler as _ai_hint_general_handler,
        handle_text_message as _handle_text_message,
