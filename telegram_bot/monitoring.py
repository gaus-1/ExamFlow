...
class BotMonitor:
    ...
    async def check_bot_health(self) -> dict[str, Any]:
        ...
        try:
            ...
            health_status["database_info"] = {"subjects_count": subjects_count}
        ...
        health_status["overall_healthy"] = (
            health_status["bot_online"]
            and health_status["database_connected"]
            and health_status["ai_working"]
        )
...
class UptimeRobotIntegration:
    ...
    def __init__(self):
        ...
        self.monitor_url = (
            getattr(settings, "SITE_URL", "https://examflow.ru") + "/healthz"
        )
        ...
        try:
            async with aiohttp.ClientSession() as session:
                ...
                async with session.post(
                    "https://api.uptimerobot.com/v2/newMonitor", data=data
                ) as resp:
