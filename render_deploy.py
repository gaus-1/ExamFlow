...
def check_tables():
    ...
    try:
        ...
        print("✅ Таблица Subject: {subject_count} записей")
        print("✅ Таблица Task: {task_count} записей")
...
def create_sample_data():
    ...
    try:
        ...
        if Subject.objects.count() == 0:  # type: ignore
            ...
            print("✅ Создано {len(subjects)} предметов")

        return True
    except Exception as e:
        print("❌ Ошибка при создании образцов данных: {e}")
        return False
