...
class TestRAGOrchestrator:
    ...
    def test_process_query_success(self, mock_logger):
        ...
        with patch.object(orchestrator, '_find_relevant_sources') as mock_find, \
             patch.object(orchestrator, '_build_context') as mock_build:
            
            mock_find.return_value = [
                {'title': 'Задание 1', 'content': 'Содержание 1', 'subject': 'Математика'}
            ]
    ...
    def test_process_query_exception(self, mock_logger):
        ...
        with patch.object(orchestrator, '_find_relevant_sources', side_effect=Exception('Test error')):
    ...
    def test_find_relevant_sources_by_subject(self):
        ...
        with patch('learning.models.Subject.objects.filter') as mock_subject_filter, \
            ...
            mock_task_filter.return_value.__getitem__.return_value = [mock_task1, mock_task2]
    ...
    def test_is_relevant_positive(self):
        ...
        result = orchestrator._is_relevant('уравнение', 'Решите уравнение', 'Найдите корень уравнения')
    ...
    def test_is_relevant_negative(self):
        ...
        result = orchestrator._is_relevant('физика', 'Математическое задание', 'Алгебра и геометрия')
...
class TestVectorStore:
    ...
    def test_search_relevant_documents(self):
        ...
        # Добавляем документы
        store.add_document('Математическое уравнение 2x + 3 = 7', {'subject': 'Математика'})
    ...
    def test_search_by_subject(self):
        ...
        store.add_document('Математика геометрия треугольники', {'subject': 'Математика'})
    ...
    def test_update_index(self):
        ...
        document = {
            'id': 0,
            'tokens': ['математика', 'уравнение', 'алгебра']
        }
    ...
    def test_get_documents_by_metadata(self):
        ...
        store.add_document('Математика 1', {'subject': 'Математика', 'difficulty': 'easy'})
        store.add_document('Математика 2', {'subject': 'Математика', 'difficulty': 'hard'})
    ...
    @patch('learning.models.Task.objects.select_related', side_effect=Exception('DB Error'))
    @patch('core.rag_system.vector_store.logger')
