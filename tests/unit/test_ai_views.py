...
from ai.views import ai_chat, ai_dashboard, api_chat, api_explain, get_ai_service
...
class TestAIViews(TestCase):
    ...
    def test_ai_dashboard_success(self):
        ...
        assert "ИИ-ассистент ExamFlow".encode() in response.content
    ...
    def test_api_chat_success(self):
        ...
        request_data = {"prompt": "Что такое ЕГЭ?", "user_id": self.user.telegram_id}
    ...
    def test_api_chat_empty_prompt(self):
        ...
        request_data = {"prompt": "", "user_id": self.user.telegram_id}
        request = self.factory.post(
            "/api/ai/chat/",
            data=json.dumps(request_data),
            content_type="application/json",
    ...
    def test_api_chat_invalid_json(self):
        ...
        request = self.factory.post(
            "/api/ai/chat/", data="invalid json", content_type="application/json"
        )
        request.user = self.user  # type: ignore
    ...
    def test_api_explain_success(self):
        ...
        request_data = {"topic": "Математика", "user_id": self.user.telegram_id}
        request = self.factory.post(
            "/api/ai/explain/",
            data=json.dumps(request_data),
            content_type="application/json",
