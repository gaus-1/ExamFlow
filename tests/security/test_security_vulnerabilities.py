...
class TestSecurityVulnerabilities(TestCase):
    ...
    def test_sql_injection_protection(self):
        ...
        for malicious_input in malicious_inputs:
            ...
            )  # Должен вернуть 200, а не 500 # type: ignore
    ...
    def test_csrf_protection(self):
        ...
        response = self.client.post(
            "/api/ai/ask/",
            {"prompt": "test prompt", "subject": "test"},
            content_type="application/json",
        )
    ...
    def test_command_injection_protection(self):
        ...
        for cmd in malicious_commands:
            ...
            response = self.client.post(
                "/api/ai/ask/",
                {"prompt": f"Execute command: {cmd}", "subject": "test"},
                content_type="application/json",
            )
    ...
    def test_authentication_bypass(self):
        ...
        protected_urls = ["/admin/", "/api/user/profile/", "/api/user/settings/"]
    ...
    def test_password_security(self):
        ...
        weak_passwords = ["123456", "password", "qwerty", "admin", "test", "12345678"]
    ...
    def test_input_validation(self):
        ...
        response = self.client.post(
            "/api/ai/ask/",
            {"prompt": long_string, "subject": "test"},
            content_type="application/json",
        )
        ...
        response = self.client.post(
            "/api/ai/ask/",
            {"prompt": 12345, "subject": ["array", "instead", "of", "string"]},
            content_type="application/json",
        )
    ...
    def test_cors_security(self):
        ...
        response = self.client.get(
            "/api/health/", HTTP_ORIGIN="https://malicious-site.com"
        )
    ...
    def test_https_enforcement(self):
        ...
        response = self.client.get("/api/health/", HTTP_X_FORWARDED_PROTO="http")
    ...
    def test_json_bomb_protection(self):
        ...
        response = self.client.post(
            "/api/ai/ask/", data=json_bomb, content_type="application/json"
        )
...
class TestCryptographicSecurity(TestCase):
    ...
    def test_telegram_hash_verification(self):
        ...
        correct_hash = hmac.new(
            bot_token.encode(), data_check_string.encode(), hashlib.sha256
        ).hexdigest()
