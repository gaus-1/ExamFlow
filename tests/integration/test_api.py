...
class TestAIAPI:
    ...
    def test_ai_api_post_success(self, authenticated_client, user, mock_ai_service):
        ...
        response = authenticated_client.post(
            "/ai/api/", data=json.dumps(data), content_type="application/json"
        )
    ...
    def test_ai_api_post_without_authentication(self, client):
        ...
        data = {"prompt": "Тестовый запрос", "subject": "Математика"}
    ...
    def test_ai_api_invalid_json(self, authenticated_client):
        ...
        response = authenticated_client.post(
            "/ai/api/", data="invalid json", content_type="application/json"
        )
...
class TestUserProgressAPI:
    ...
    def test_user_progress_statistics(
        self, authenticated_client, user, math_task, russian_task
    ):
...
class TestCORS:
    ...
    def test_cors_headers_present(self, client):
        ...
        assert (
            ...
            or "Access-Control-Allow-Methods" in response
        )
