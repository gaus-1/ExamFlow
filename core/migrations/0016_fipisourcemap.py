    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('data_type', models.CharField(choices=[('demo_variant', 'Демонстрационный вариант'), ('specification', 'Спецификация КИМ'), ('codefier', 'Кодификатор'), ('open_bank_task', 'Задание из открытого банка'), ('methodical_material', 'Методический материал'), ('news', 'Новости и анонсы'), ('document', 'Официальные документы')], max_length=50, verbose_name='Тип данных')),
                ('exam_type', models.CharField(choices=[('ege', 'ЕГЭ'), ('oge', 'ОГЭ'), ('gve_11', 'ГВЭ-11'), ('gve_9', 'ГВЭ-9'), ('essay', 'Итоговое сочинение'), ('interview', 'Итоговое собеседование')], max_length=20, verbose_name='Тип экзамена')),
                ('subject', models.CharField(blank=True, max_length=100, null=True, verbose_name='Предмет')),
                ('priority', models.IntegerField(choices=[(1, 'Критически важные'), (2, 'Высокий приоритет'), (3, 'Средний приоритет'), (4, 'Низкий приоритет')], default=3, verbose_name='Приоритет')),
                ('update_frequency', models.CharField(choices=[('annually', 'Ежегодно'), ('monthly', 'Ежемесячно'), ('weekly', 'Еженедельно'), ('daily', 'Ежедневно'), ('on_demand', 'По требованию')], default='annually', max_length=20, verbose_name='Частота обновления')),
                ('file_format', models.CharField(choices=[('HTML', 'HTML'), ('PDF', 'PDF'), ('DOC', 'DOC'), ('XLS', 'XLS'), ('XLSX', 'XLSX')], default='HTML', max_length=10, verbose_name='Формат файла')),
