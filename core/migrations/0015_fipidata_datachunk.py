    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('data_type', models.CharField(choices=[('demo_variant', 'Демонстрационный вариант'), ('open_bank_task', 'Задание из открытого банка'), ('specification', 'Спецификация'), ('codifier', 'Кодификатор')], max_length=50, verbose_name='Тип данных')),
