...
class UserBehaviorAnalyzer:
    ...
    def _analyze_subject_preferences(self):
        ...
        try:
            ...
            for progress in subject_progress:
                ...
                accuracy = (progress['correct_attempts'] /
                            progress['total_attempts']) * 100
    ...
    def _analyze_task_preferences(self):
        ...
        try:
            ...
            difficulty_preferences = UserProgress.objects.filter(  # type: ignore
                ...
                success_rate=Count(
                    'id', filter=Q(
                        is_correct=True)) * 100.0 / Count('id')
            )
    ...
    def _determine_difficulty_level(self):
        ...
        try:
            ...
            success_rate = recent_progress.filter(
                is_correct=True).count() / recent_progress.count()
