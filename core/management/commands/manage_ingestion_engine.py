...
class Command(BaseCommand):
    ...
    def start_engine(self, options):
        ...
        try:
            if options['with_scheduler']:
                ...
                self.stdout.write(
                    self.style.SUCCESS(
                        '✅ Движок сбора данных и планировщик запущены')  # type: ignore
                )
            else:
    ...
    def stop_engine(self, options):
        ...
        try:
            if options['with_scheduler']:
                ...
                self.stdout.write(
                    self.style.SUCCESS(
                        '✅ Движок сбора данных и планировщик остановлены')  # type: ignore
                )
            else:
                ...
                self.stdout.write(
                    self.style.SUCCESS(
                        '✅ Движок сбора данных остановлен')  # type: ignore
                )
    ...
    def monitor_engine(self):
        ...
        self.stdout.write(
            self.style.SUCCESS(
                '👁️ Мониторинг движка (Ctrl+C для выхода)')  # type: ignore
        )
