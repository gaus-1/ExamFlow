...
class Command(BaseCommand):
    ...
    def show_statistics(self):
        ...
        try:
            ...
            self.stdout.write(f'Обновлений по математике: {stats.get("math_updates", 0)}')
            self.stdout.write(f'Обновлений по русскому языку: {stats.get("russian_updates", 0)}')
    ...
    def continuous_monitoring(self):
        ...
        try:
            ...
            while True:
                ...
                self.stdout.write(f'Следующая проверка через {fipi_monitor.check_interval} секунд...')
