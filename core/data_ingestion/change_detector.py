...
class ChangeDetector:
    ...
    def detect_changes(self, source_ids: Optional[List[str]] = None) -> List[ChangeEvent]:
    ...
    def _determine_change_type(self, source: FIPISourceMap, current_hash: str) -> ChangeType:
...
class ChangeNotificationService:
    ...
    def _send_notification(self, change_type: str, changes: List[ChangeEvent]):
        ...
        try:
            ...
            # Логирование
            logger.info(f"Уведомление отправлено: {change_type} - {len(changes)} изменений")
    ...
    def _send_email_notification(self, change_type: str, changes: List[ChangeEvent]):
        ...
        try:
            ...
            html_message = render_to_string('monitoring/change_notification.html', context)
