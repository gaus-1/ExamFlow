                ...
                for img_index, img in enumerate(image_list):
                    try:
                        ...
                        if pix.n - pix.alpha < 4:  # GRAY или RGB
                            ...
                            ocr_text, confidence = self.ocr_processor.extract_text_from_image(processed_image)
...
class PDFVectorizer:
        ...
        for chunk in chunks:
            try:
                ...
                if embedding:
                    ...
                    logger.warning(f"Не удалось сгенерировать эмбеддинг для чанка: {chunk.text[:100]}...")
    ...
    def _get_embedding(self, text: str) -> Optional[List[float]]:
        ...
        try:
            ...
            embed_model = genai.EmbeddingModel(model_name='text-embedding-004')  # type: ignore
...
class PDFProcessor:
    ...
    def _save_chunks_to_db(self, fipi_data: FIPIData, vectorized_chunks: List[Dict[str, Any]]) -> int:
