...
class VectorStore:
    ...
    def search_by_subject(self, query: str, subject: str, limit: int = 5) -> List[Dict[str, Any]]:
        """
        Поиск по предмету
    ...
    def _tokenize(self, text: str) -> List[str]:
        ...
        # Убираем стоп-слова
        stop_words = {'и', 'в', 'на', 'с', 'по', 'для', 'от', 'к', 'из', 'о', 'а', 'но', 'или', 'что', 'как', 'это', 'все', 'еще', 'уже', 'только', 'может', 'быть', 'есть', 'был', 'была', 'было', 'были'}
