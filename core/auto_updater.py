...
class AutoUpdater:
    ...
    def start_scheduler(self):
        ...
        schedule.every().sunday.at("02:00").do(self.weekly_update)  # Еженедельно в воскресенье в 2:00
    ...
    def cleanup_old_data(self):
        ...
        try:
            ...
            if deleted_audio > 0 or deactivated_count > 0:
                logger.info(f"🧹 Очистка: удалено аудио {deleted_audio}, деактивировано заданий {deactivated_count}")
    ...
    def _send_admin_notification(self, message):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                logger.warning(f"⚠️ Ошибка отправки уведомления: {response.status_code}")
    ...
    def manual_update(self):
        ...
        try:
            ...
            logger.info(f"📊 Предметов: {subjects_count}, Заданий: {tasks_count}, Примеров: {sample_tasks}")
