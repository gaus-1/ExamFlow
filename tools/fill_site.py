...
def main():
    ...
    try:
        ...
        print("🗺️  Источников создано: {sources_created}")
        print("📝 Примеров создано: {samples_created}")
        print("📄 Документов собрано: {docs_collected}")
        print("📄 PDF обработано: {pdf_processed}")
        print("📋 Всего в базе: {FIPIData.objects.count()}")  # type: ignore
