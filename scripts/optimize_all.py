...
def main():
    ...
    # Список оптимизаций
    optimizations = [
        ('optimize_security.py', 'Оптимизация безопасности'),
        ('optimize_performance.py', 'Оптимизация производительности'),
        ('optimize_code_quality.py', 'Улучшение качества кода'),
    ]
    ...
    for script_name, description in optimizations:
        if run_optimization_script(script_name, description):
            ...
            print(f"⚠️ Оптимизация {description} завершилась с ошибками")
