...
class PersonalizedAiService:
    ...
    def get_personalized_response(self, prompt: str, user: User, task=None, context_type: str = 'general') -> Dict[str, Any]:
        ...
        try:
            ...
            enhanced_prompt = self._enhance_prompt_with_context(prompt, user_insights, context_type, task)
            
            # Получаем базовый ответ от AI
            if task:
                try:
                    ai_response = self.ai_service.ask_with_rag(enhanced_prompt, user, task, context_type)
            ...
            return {
                ...
                'personalization_data': {
                    ...
                    'weak_topics': user_insights.get('weak_topics', [])[:3],
                    'recommendations': self._get_context_recommendations(user_insights, context_type, task)
                }
            }
    ...
    def _enhance_prompt_with_context(self, prompt: str, user_insights: Dict, context_type: str, task=None) -> str:
    ...
    def _enhance_response_with_personalization(self, ai_response: str, user_insights: Dict, context_type: str, task=None) -> str:
    ...
    def _get_context_recommendations(self, user_insights: Dict, context_type: str, task=None) -> List[Dict]:
