...
from .models import AiLimit, AiPromptTemplate, AiProvider, AiRequest, AiResponse
...
class AiRequestAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ("Статистика", {"fields": ("tokens_used", "cost", "ip_address", "created_at")}),
    )
...
class AiLimitAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ("Использование", {"fields": ("current_usage", "reset_date")}),
...
class AiProviderAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ("API настройки", {"fields": ("api_key", "api_url", "max_tokens_per_request")}),
        (
            "Лимиты и стоимость",
            {"fields": ("daily_limit", "daily_usage", "cost_per_token")},
        ),
        ("Статистика", {"fields": ("response_time_avg", "success_rate", "last_used")}),
        ("Системная информация", {"fields": ("created_at", "updated_at")}),
    )
...
class AiPromptTemplateAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ("Шаблон", {"fields": ("prompt_template", "variables")}),
        ("Системная информация", {"fields": ("created_at", "updated_at")}),
    )
...
class AiResponseAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Основная информация", {"fields": ("prompt_hash", "provider")}),
        ("Контент", {"fields": ("prompt", "response")}),
        (
            "Статистика",
